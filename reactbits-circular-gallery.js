// Exact ReactBits Circular Gallery Implementation
// Based on https://reactbits.dev/components/circular-gallery
...
class Title {
  constructor({ gl, plane, renderer, text, textColor = "#AFBB30", font = "30px sans-serif" }) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
...
class ReactBitsCircularGallery {
  constructor(
    container,
    {
      items,
      bend = 0, // Your setting: bend level 0
      textColor = "#AFBB30",
      borderRadius = 0.05,
...
window.ReactBitsCircularGallery = ReactBitsCircularGallery;
